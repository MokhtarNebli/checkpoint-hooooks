  ...
  const [Movielist, setMovieList] = useState([
    {
      title: "Troll ",
      description:
        "Deep in the mountain of Dovre, something gigantic awakens after being trapped for a thousand years. Destroying everything in its path, the creature is rapidly approaching the capital of Norway. A group of people band together to stop him from causing deadly havoc.",
      posterURL:
    ...
    },
    {
      title: "Avatar 2",
      description:
        "Jake Sully and Ney'tiri have formed a family and do everything to stay as close together as possible. However, they are forced to leave their homes and explore the different still mysterious regions of Pandora. When an old threat resurfaces, Jake will have to fight an uphill war against the humans.",
      posterURL:
        "https://iegybest.stream/wp-content/uploads/2022/12/Avatar-The-Way-of-Water.jpg",
      rating: 4,
    },
    {
      title: "Black Adam",
      description:
        "In ancient Kahndaq, Teth Adam received almighty powers from the gods. After using these powers for revenge, he was imprisoned, becoming Black Adam. Almost 5,000 years have passed and Black Adam has gone from man to myth to legend.",
      posterURL:
        "https://iegybest.stream/wp-content/uploads/2022/10/Black-Adam.jpg",
      rating: 5,
    },
    {
      ...
      posterURL:
        " https://fr.web.img6.acsta.net/c_310_420/pictures/22/10/17/10/28/5232325.jpg",
      rating: 3,
    },
  ]);
